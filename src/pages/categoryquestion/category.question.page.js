...
import CategoryQuestionDialog from './components/CategoryQuestionDialog'
...
const CategoryQuestion = () => {
    ...
    const deleteCategory = async (category) => {
        ...
        const response = await HttpClient.delete('/api/categoryquestion/' + category._id);
